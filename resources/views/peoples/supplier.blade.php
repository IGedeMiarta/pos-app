            ...
            <div class="modal-content">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="name" class="form-label">CP<span class="text-danger">*</span></label>
