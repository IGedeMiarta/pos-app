    ...
    <form action="{{ url('pos') }}" method="POST" id="pos" enctype="multipart/form-data" target="_blank">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input type="text"
                        class="form-control ref @error('reference')
                            is-invalid
                        @enderror"
                        name="reference" value="{{ ref('TRX') }}" readonly>
                    @error('reference')
        ...
        <div class="card ">
            <div class="card-body row">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <label for="name" class="form-label ">Bayar</label>
                        <input type="number" name="dp" class="form-control bayar">
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        <label for="name" class="form-label ">Kembali</label>
                        <input type="text" class="form-control kembali" readonly>
                    </div>
                    <div class="mb-3">
...
@push('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.bayar').on('keyup', delay(function() {
                var val = parseInt($(this).val());
                var total = parseInt($('.totalVal').val());
                var dc = val - total;
                $('.kembali').val(formatNumber(dc));
            }, 500));
